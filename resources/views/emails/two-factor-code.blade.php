...
<head>
    <meta charset="utf-8">
    <title>Your ZULU sign-in code</title>
</head>
<body style="font-family:Arial,Helvetica,sans-serif;color:#222;line-height:1.5;max-width:600px;margin:24px auto;padding:0 16px;">
    <h2 style="color:#1A3C6E;margin-bottom:8px;">Your sign-in code</h2>

    <p>Hello {{ $user->name }},</p>

    <p>
        Use this 6-digit code to finish signing in to ZULU. It expires in
    ...
    <p style="color:#555;font-size:14px;">
        If you didn't try to sign in just now, you can ignore this email —
        nobody can log in without it. If this keeps happening, change your
        password and contact us at
        <a href="mailto:security@zulu.am" style="color:#7c3aed;">security@zulu.am</a>.
    </p>
