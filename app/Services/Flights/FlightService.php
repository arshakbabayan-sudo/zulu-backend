...
class FlightService
{
    ...
    public function listForCompanies(array $companyIds, array $filters = []): Collection
    {
        ...
        return $query->with(['offer', 'company', 'departureLocation', 'arrivalLocation', 'offer.translations'])->get();
    }
    ...
    public function paginateForCompanies(array $companyIds, array $filters, int $perPage = 20): LengthAwarePaginator
    {
        ...
        return $query->with(['offer', 'company', 'departureLocation', 'arrivalLocation', 'offer.translations'])->paginate($perPage);
    }
