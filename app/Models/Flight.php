...
class Flight extends Model
{
    ...
    public function toOfferEmbedArray(): array
    {
        ...
        return [
            ...
            'departure_country' => ($this->getAttributes()['departure_country'] ?? null) ?: $departureLabels['country'],
            'departure_city' => ($this->getAttributes()['departure_city'] ?? null) ?: $departureLabels['city'],
            'departure_airport' => $this->departure_airport,
            'arrival_country' => ($this->getAttributes()['arrival_country'] ?? null) ?: $arrivalLabels['country'],
            'arrival_city' => ($this->getAttributes()['arrival_city'] ?? null) ?: $arrivalLabels['city'],
