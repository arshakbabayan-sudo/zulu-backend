...
class CompanyApplicationController extends Controller
{
    ...
    public function store(Request $request, CompanyApplicationApprovalService $companyApplicationApprovalService): JsonResponse
    {
        ...
        $companyApplicationApprovalService->createPendingApprovalForApplication($application);
