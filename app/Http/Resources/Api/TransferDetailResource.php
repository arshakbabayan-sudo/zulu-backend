...
class TransferDetailResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        // Phase 1 / B.3 — base_price visibility gated by trait. Transfer
        // belongs to a company directly (Transfer.company_id).
        ...
        return [
            ...
            'pickup_point_name' => $this->getTranslated('pickup_point_name', $lang) ?? $this->pickup_point_name,
            'dropoff_country' => $this->dropoff_country,
            'destination_location_id' => $this->destination_location_id,
            'dropoff_city' => $this->dropoff_city,
            'dropoff_point_type' => $this->dropoff_point_type,
            'dropoff_point_name' => $this->getTranslated('dropoff_point_name', $lang) ?? $this->dropoff_point_name,
